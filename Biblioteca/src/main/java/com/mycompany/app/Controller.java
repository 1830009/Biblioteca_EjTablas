...
public class Controller {
    ...
    //Metodo para inicializar las tablas y mostrar sus datos
    //Variables a cambiar Tbl_name y SelectorTablaname
    ...
    //Variables para obtener los datos de las tablas
    ...
    //V_Usuario Declaracion de columnas y Tabla
    ...
    //1. Metodo para la tabla, saber que fila esta seleccionada
    ...
    //5. Inicializar la tabla, sus columnas, usuario es la tabla, y entre parentesis son sus atributos
     void Ini_TablaUsuario(){
        ...
        //En la sig intruccion se asigna los datos a una nueva lista para ser agregadas a la tabla
    ...
    //**********************************************************************************************************
    //A1.Comienza los mismos metodos para la tabla prestamos
